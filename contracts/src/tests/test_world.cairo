...
//     use squares::systems::actions::{actions, IActionsDispatcher, IActionsDispatcherTrait};
//     use squares::models::{Position, m_Position, Moves, m_Moves, Direction};

//     fn namespace_def() -> NamespaceDef {
//         let ndef = NamespaceDef {
//             namespace: "squares", resources: [
...
//         [
//             ContractDefTrait::new(@"squares", @"actions")
//                 .with_writer_of([dojo::utils::bytearray_hash(@"squares")].span())
//         ].span()
//     }
